...
class GenreController extends FrontendController
{
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post()) && $model->save()) {
                Yii::$app->getSession()->setFlash('success', 'Запись "Жанр" успешно создана');
    ...
    public function actionUpdate($id)
    {
        ...
        if ($this->request->isPost && $model->load($this->request->post()) && $model->save()) {
            Yii::$app->getSession()->setFlash('success', 'Запись "Жанр" успешно обновлена');
            return $this->redirect(['/genre']);
        }
    ...
    public function actionDelete($id)
    {
        ...
        Yii::$app->getSession()->setFlash('success', 'Запись "Жанр" успешно удалена');
